...
# }
# 
# with Diagram("Datatower", direction="TB", graph_attr=graph_attr) as in_source:
#     api = Container("API Server", "Python") 
# 
#     with Cluster("Source of Event/Attribute"):
#         ios = Person(name="iOS")
#         android = Person(name="Android")
#         web = Person(name="Web")
#         py = Person(name="Python")
#         unity = Person(name="Unity")
#         
#         # [ ios, android, web, py, unity ] >> api
#         in_source >> api
# 
#     with Cluster("Bigdata Module"):
#         kafka = Kafka()
#         flink = Flink()
#         hadoop = Hadoop()
# 
